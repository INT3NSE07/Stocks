 ...
 * perform and is delegated tasks by the controller when the user gives an input that to perform one
 * of these operations.
 */
public interface PortfolioModel {
   ...
   * manually by taking in user input of what stocks they want to add and what they want to name
   * it.
   *
  ...
  /**
   * Invests a given amount of money into an investment plan of stocks to buy and percentage of
   * money to spend on each stock.
   *
   * @param name            name of the portfolio to invest in
   * @param totalInvestment total amount being invested
   * @param map             the breakdown of the ticker and the percentage of total amount to invest
   *                        in it
