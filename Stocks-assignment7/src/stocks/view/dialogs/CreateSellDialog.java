...
/**
 * This class represents the dialog created when the user tries to sell stocks for a portfolio.
 */
public class CreateSellDialog extends AbstractDialog {

  private final List<String> names;

  /**
   * This constructor creates a Sell Dialog that the user can interact with.
   ...
   */
  public CreateSellDialog(JFrame parent, List<String> names) {
    super(parent);
    this.names = names;
  }
  ...
  public JDialog createDialog() {
    ...
    JLabel choosePortfolio = new JLabel("Choose portfolio to sell stocks from");
    ...
    gbc.gridy = 4;
    gbc.ipady = 5;
    JButton addButton = new JButton("Sell from portfolio");
